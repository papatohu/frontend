...
exports.getDefaultProject = exports.addFontsToIndexHtml = exports.importDefaultTheme = void 0;
...
function importDefaultTheme(tree) {
    return __awaiter(this, void 0, void 0, function* () {
        const sourceRoot = (yield getDefaultProject(tree)).sourceRoot;
...
function addFontsToIndexHtml(tree) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const project = yield getDefaultProject(tree);
...
function getDefaultProject(tree) {
    return __awaiter(this, void 0, void 0, function* () {
