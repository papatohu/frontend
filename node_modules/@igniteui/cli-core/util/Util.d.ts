...
export declare const defaultDelimiters: TemplateDelimiters;
export declare type ChoiceItem = Pick<Template | ComponentGroup, "name" | "description"> | Component;
export declare class Util {
    static getCurrentDirectoryBase(): string;
    static directoryExists(dirPath: any): boolean;
    ...
    static processTemplates(sourcePath: string, destinationPath: string, configuration: {
        [key: string]: string;
    }, delimiters: TemplateDelimiters, validate?: boolean): Promise<boolean>;
    ...
    static version(filePath?: string): string;
    static showVersion(filePath: any): void;
     ...
     */
    static execSync(command: string, options?: any): string;
    /**
     ...
     */
    static color(text: string, colorKeyword: string): string;
    ...
    static formatChoices(items: ChoiceItem[], padding?: number): Array<{
        name: string;
        value: string;
        short: string;
    }>;
    static applyDelimiters(config: {
        [key: string]: string;
    }, delimiter: Delimiter): {};
    private static incrementName;
